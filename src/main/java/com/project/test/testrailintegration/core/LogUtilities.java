...
public final class LogUtilities {
	...
	/**
	 * Utilities getInstance() Returns the Utilities instance
	 * <p>
	 * The method returns member variable <i>instance</i>, instantiating the
	 * variable if it instantiated wasn't already.
	 *
	 * Note: Make this a Singleton.
	 *
	 ...
	 * Logs the message.
	 * <p>
	 * The method gives the member <i>logger</i> the message <i>msg</i>, then logs
	...
	/**
	 * void logWarningMessage(String msg)
	 * <p>
	...
	/**
	 * void logSevereMessage(String msg)
	 * <p>
	 * Logs the severe message.
	 * <p>
	 * The method gives the member <i>logger</i> the message <i>msg</i>, then logs
	 * it through the report.
	 *
